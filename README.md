...
## SpringIOC容器和SpringMVC IOC容器的关系 ##

SpringMVC的IOC容器中的bean可以来引用Spring IOC容器中的 bean. 反回来呢 ? 反之则不行. Spring IOC 容器中的 bean 却不能来引用 SpringMVC IOC 容器中的 bean 
